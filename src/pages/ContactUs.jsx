              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <motion.div variants={itemVariants}>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#8C52FF] focus:border-transparent transition-all duration-300 bg-white"
                    required
                  />
                </motion.div>
                ...
                <motion.div variants={itemVariants}>
                  ...
                  <textarea
                    ...
                    className="w-full border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#8C52FF] focus:border-transparent transition-all duration-300 bg-white resize-none"
                    required
                  ></textarea>
                </motion.div>
