...
const Footer = () => {
  ...
  // ✅ Social Links Data (LinkedIn Added)
  const socialLinks = [
    {
      icon: "whatsapp-line",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 mb-12">
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-3">
                <a href="/" className="block text-gray-300 hover:text-[#8C52FF] font-medium transition-colors">Home</a>
                <a href="/about" className="block text-gray-300 hover:text-[#8C52FF] font-medium transition-colors">About Us</a>
                <a href="/explore" className="block text-gray-300 hover:text-[#8C52FF] font-medium transition-colors">Explore</a>
                <a href="/contact" className="block text-gray-300 hover:text-[#8C52FF] font-medium transition-colors">Contact Us</a>
              </div>
              <div className="space-y-3">
                <a href="/course" className="block text-gray-300 hover:text-[#8C52FF] font-medium transition-colors">Courses</a>
                <a href="/blogs" className="block text-gray-300 hover:text-[#8C52FF] font-medium transition-colors">Blogs</a>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 leading-relaxed text-sm">
              Connecting educators and learners through innovative platforms that transform research worldwide. Join us in revolutionizing the future.
            </p>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              {socialLinks.map(({ icon, href, label }) => (
                <a
                  ...
                  aria-label={label}
                  className="w-10 h-10 rounded-full border border-gray-600 flex items-center justify-center text-gray-300 hover:bg-[#8C52FF] hover:text-white transition-all duration-200"
                >
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center pt-8 border-t border-gray-700">
          <div className="flex gap-6 text-sm text-gray-400 mb-4 sm:mb-0">
            ...
            <a href="/returns" className="hover:text-[#8C52FF] transition-colors">Return Policy</a>
          </div>
