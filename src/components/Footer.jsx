    ...
    <footer className="bg-gray-50 mt-24 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              {["facebook-fill", "instagram-fill", "youtube-fill", "linkedin-fill"].map((icon) => (
                <button
                  key={icon}
                  className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-600 hover:bg-[#8C52FF] hover:text-white transition-all duration-200 shadow-sm"
                >
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center pt-8 border-t border-gray-200">
          {/* Legal Links first */}
          <div className="flex gap-6 text-sm text-gray-500 mb-4 sm:mb-0">
