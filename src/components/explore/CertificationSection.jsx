...
export default function CertificationSection() {
  ...
  // Function to check if course is 3D Printing
  const is3DPrintingCourse = (courseTitle) => {
    return courseTitle === "3D Printing";
  };
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          {certifications.map((cert) => {
            const isEnabled = is3DPrintingCourse(cert.title);
                ...
                <div className="w-full md:w-1/2">
                  ...
                  <div className="flex gap-3 md:justify-end flex-wrap">
                    {isEnabled ? (
                      ...
                      <button 
                        className="bg-[#f8f9fa] border border-gray-200 rounded-full px-5 py-2 text-sm font-medium text-gray-500 cursor-not-allowed"
                        disabled
                      >
                        Launch Soon...
                      </button>
